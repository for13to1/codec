          ...
          {          
            ...
            if ((iabs( R0 - R1) < Beta )   && (iabs(L0 - L1) < Beta ))
            {
              ...
              {              
                ...
                if( ap && (C0 != 0))
                  *(SrcPtrP - 1) += (imgpel)iClip3( -C0,  C0, ( L2 + RL0 - (L1 << 1)) >> 1 ) ;
                ...
                if( aq  && (C0 != 0))
                  *(SrcPtrQ + 1) += (imgpel)iClip3( -C0,  C0, ( R2 + RL0 - (R1 << 1)) >> 1 ) ;
              }            
            }
          }
        }
          ...
          if( iabs( R0 - L0 ) < Alpha )
          {
            ...
            if ((iabs( R0 - R1) < Beta )   && (iabs(L0 - L1) < Beta ))
            {
              ...
              {              
                ...
                if( ap && (C0 != 0))
                  *(SrcPtrP - incP) += (imgpel)iClip3( -C0,  C0, ( L2 + RL0 - (L1 << 1)) >> 1 ) ;
                ...
                if( aq  && (C0 != 0))
                  *(SrcPtrQ + incQ) += (imgpel)iClip3( -C0,  C0, ( R2 + RL0 - (R1 << 1)) >> 1 ) ;
              }            
            }
          }        
        }  
