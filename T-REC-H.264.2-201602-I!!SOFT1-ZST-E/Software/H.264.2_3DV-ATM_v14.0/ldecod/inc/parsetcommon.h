...
typedef struct
{
  ...
  int *depth_view_present_flag;
  int *texture_view_present_flag;
  int num_coded_depth_view;
#endif
...
#if EXT3D
  int ***applicable_op_depth_flag;
  int ***applicable_op_texture_flag;
#endif
  int **applicable_op_num_views_minus1;
#if EXT3D
  int **applicable_op_num_texture_views_minus1;
  int **applicable_op_num_depth_views;
  unsigned int threedvc_vui_parameters_present_flag;
  unsigned int texture_vui_parameters_present_flag;
  MVCVUI_t  TexVUIParams;
#endif
...
{
  Boolean   valid;
  subset_seq_parameter_set_rbsp_t *subset_mvc_sps;

  Boolean depth_info_present_flag;

  int acquisition_idx;

  int camera_order[MAX_CODEVIEW];

  int num_of_views_minus1;
  ThreeDVAcquisitionInfo* threeDV_acquisition_in_subsps;

  int disparity_param_prec;

  int tex_voidx_delta[MAX_CODEVIEW];

  Boolean reduced_resolution;
  int ori_width_in_MB_minus1;
  int ori_height_in_MB_minus1;
...
#if EXT3D
int dps_is_equal(depth_parameter_set_rbsp_t *dps1, depth_parameter_set_rbsp_t *dps2);
#endif
