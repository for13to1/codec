...
#if EXT3D
extern void CopySliceHeader  (Slice *pSlice, int src);
extern void CopySliceRefList (Slice *pSlice, int src);
extern void CopySlicePredWeightTable (Slice *pSlice, int src);
extern void CopySliceDecRefPicMarking(Slice *pSlice, int src);
