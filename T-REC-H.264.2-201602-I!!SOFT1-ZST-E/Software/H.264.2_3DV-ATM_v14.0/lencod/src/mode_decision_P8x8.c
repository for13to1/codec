...
#if EXT3D
        motion[block_y    ][block_x    ].isVSPRef[LIST_0] = currSlice->isVSPRef[LIST_0][b_ref][mode][j1    ][i1    ];
        motion[block_y    ][block_x + 1].isVSPRef[LIST_0] = currSlice->isVSPRef[LIST_0][b_ref][mode][j1    ][i1 + 1];
        motion[block_y + 1][block_x    ].isVSPRef[LIST_0] = currSlice->isVSPRef[LIST_0][b_ref][mode][j1 + 1][i1    ];
        motion[block_y + 1][block_x + 1].isVSPRef[LIST_0] = currSlice->isVSPRef[LIST_0][b_ref][mode][j1 + 1][i1 + 1];
#endif
...
#if EXT3D
          motion[block_y     ][block_x    ].isVSPRef[k] = currSlice->isVSPRef[k][(short) best.ref[k]][mode][j1    ][i1    ];
          motion[block_y     ][block_x + 1].isVSPRef[k] = currSlice->isVSPRef[k][(short) best.ref[k]][mode][j1    ][i1 + 1];
          motion[block_y  + 1][block_x    ].isVSPRef[k] = currSlice->isVSPRef[k][(short) best.ref[k]][mode][j1  +1][i1    ];
          motion[block_y  + 1][block_x + 1].isVSPRef[k] = currSlice->isVSPRef[k][(short) best.ref[k]][mode][j1  +1][i1 + 1];
#endif
