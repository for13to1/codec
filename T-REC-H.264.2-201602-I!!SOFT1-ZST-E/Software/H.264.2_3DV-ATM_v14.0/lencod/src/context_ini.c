...
#if EXT3D
    BIARI_CTX_INIT2 (qp, 3, NUM_MB_TYPE_CTX,   mc->mb_vsskip_flag_contexts, INIT_VS_SKIP_P[model_number]);

    BIARI_CTX_INIT2 (qp, 3, NUM_MB_TYPE_CTX,   mc->vspflag_contexts, INIT_MB_TYPE_P[model_number]);
#endif
...
#if EXT3D 
    binary_context_init1(qp, NUM_MB_ALC_CTX, mc->ALC_flag_ctx, INIT_MB_ALC_FLAG_CTX);
    binary_context_init1(qp, NUM_MB_ALC_CTX, mc->ALCskip_flag_ctx, INIT_MB_ALCSKIP_FLAG_CTX);
#endif
  }
}
...
#if EXT3D
      ADD_XRATE2 (p_Vid, 3, NUM_MB_TYPE_CTX,   mc->mb_vsskip_flag_contexts, INIT_VS_SKIP_P [model]);
      ADD_XRATE2 (p_Vid, 3, NUM_MB_TYPE_CTX,   mc->vspflag_contexts,     INIT_MB_TYPE_P [model]);
#endif
