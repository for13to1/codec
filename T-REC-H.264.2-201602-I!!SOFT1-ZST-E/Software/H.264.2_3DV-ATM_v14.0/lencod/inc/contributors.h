 ...
 *  \par Copyright statements
   ...
   University of Science and Technology of China / Dept. of EEIS
   Nokia Inc., USA
   Qualcomm Inc., USA
   ...
   \verbatim
      ...
      Wenyi Su              <suwy@mail.ustc.edu.cn>
      Ri    Li                        <lrzkd@mail.ustc.edu.cn>
      Lulu  Chen            <clulu@mail.ustc.edu.cn>
      Deyan Lan              <landy@mail.ustc.edu.cn>
      University of Science and Technology of China / Dept. of EEIS
      443 Huangshan Road, P.O.Box 4 Hefei, Anhui, 230027,China

      Li Zhang                        <lizhang@qualcomm.com>
      Ying Chen                       <cheny@qualcomm.com>
      5775 Morehouse Dr 
      ...
      Polanka 3, 60-096 Poznan, Poland

      Mikhail Mishourovsky            <mike.mishky@samsung.com>
      Alexey Fartukov                 <a.fartukov@samsung.com>
      Igor Kovliga                    <i.kovliga@samsung.com>
      Samsung Moscow Research Center 
      Office #1500, 12, Dvintsev str., bld. 1, Moscow, Russia, 127018
