...
#if EXT3D
static const char mb_mode_table[11]  = {0, 1, 2, 3, P8x8, I16MB, I4MB, I8MB, IPCM, SI4MB, PVSP_SKIP}; // DO NOT CHANGE ORDER !!!
#else
...
#if EXT3D 
extern void init_alc_enc_mb_params(Macroblock* currMB, RD_PARAMS *enc_mb);
#endif
