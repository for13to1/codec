...
extern void writeMB_Pvsskip_flagInfo_CABAC(Macroblock *currMB, SyntaxElement *se, DataPartition *dp);
extern void writeMB_Bvsskip_flagInfo_CABAC(Macroblock *currMB, SyntaxElement *se, DataPartition *dp);
extern void writeMB_Bdirect_typeInfo_CABAC(Macroblock *currMB, SyntaxElement *se, DataPartition *dp);

extern void writeMB_Ref_PVSP_flagInfo_CABAC(Macroblock *currMB, int list, SyntaxElement *se, DataPartition *dp);
extern void writeMB_Ref_BVSP_flagInfo_CABAC(Macroblock *currMB, int list, SyntaxElement *se, DataPartition *dp);
#endif
...
#if EXT3D 
extern void write_ALC_flag_CABAC(Macroblock *currMB, SyntaxElement *se, DataPartition *dp);
extern void write_ALCskip_flag_CABAC(Macroblock *currMB, SyntaxElement *se, DataPartition *dp);

extern void encodeSeriesBreakIndicator( int max_len, int position, EncodingEnvironmentPtr eep_dp);
#endif
