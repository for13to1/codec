...
#if EXT3D
  float  bitrate_v[MAX_CODEVIEW];                     //!< average bit rate for the sequence except first frame
  int64  bit_ctr_v[MAX_CODEVIEW];                     //!< counter for bit usage
  int64  bit_ctr_n_v[MAX_CODEVIEW];                   //!< bit usage for the current frame
  int64  bit_ctr_emulationprevention_v[MAX_CODEVIEW]; //!< stored bits needed to prevent start code emulation
  int64  bit_counter_v[MAX_CODEVIEW][NUM_SLICE_TYPES];
  int    bit_ctr_parametersets_v[MAX_CODEVIEW];
  int    bit_ctr_parametersets_n_v[MAX_CODEVIEW];
  int64  bit_ctr_filler_data_v[MAX_CODEVIEW];
  int64  bit_ctr_filler_data_n_v[MAX_CODEVIEW];
  int64  bit_3dv_update_info;
