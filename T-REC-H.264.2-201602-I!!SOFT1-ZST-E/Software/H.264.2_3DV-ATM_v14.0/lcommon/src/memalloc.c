 ...
 ************************************************************************
 */
int get_mem4Ddouble(double *****array4D, int dim0, int dim1, int dim2, int dim3)
{
  int  i, mem_size = dim0 * sizeof(double***);

  if(((*array4D) = (double****)malloc(dim0 * sizeof(double***))) == NULL)
    no_mem_exit("get_mem4Dint: array4D");

  mem_size += get_mem3Ddouble(*array4D, dim0 * dim1, dim2, dim3);
 ...
 * \brief
 *    free 3D memory array
 *    which was alocated with get_mem3Ddouble()
 ************************************************************************
 */
 ...
 * \brief
 *    free 4D memory array
 *    which was allocated with get_mem4Ddouble()
 ************************************************************************
 */
void free_mem4Ddouble(double ****array4D)
{
  if (array4D)
  {
    free_mem3Ddouble( *array4D);
    free (array4D);
  } else
  {
    error ("free_mem4D: trying to free unused memory",100);
