...
#ifndef _DEC_RECON_TEST_H_
#define _DEC_RECON_TEST_H_
...
#define DEMUX_MODE_SWITCH           "--deMuxMode"
...
#define NUM_YUV_READ_FILES 3
#define NUM_YUV_WRITE_FILES 2
 ...
 * \param[out]  pu16_deMuxMode          Specifies Demux Mode. 0 - FC , 1-OM.
 ...
 *
 * \brief Prints the usage of  reconstruction test application.
 *
