...
void init_lists_p_slice_mvc(Slice *currSlice)
{
  ...
  {        
    ...
    {
#if (MFC_DEPTH_DEC)
	  append_interview_list(p_Vid->p_Dpb_layer[is_depth][1], 0, 0, currSlice->fs_listinterview0, &currSlice->listinterviewidx0, currPOC, curr_view_id, anchor_pic_flag);
	#else
    ...
    {
#if (MFC_DEPTH_DEC)
      append_interview_list(p_Vid->p_Dpb_layer[is_depth][1], currSlice->structure, 0, currSlice->fs_listinterview0, &currSlice->listinterviewidx0, currPOC, curr_view_id, anchor_pic_flag);
#else	
