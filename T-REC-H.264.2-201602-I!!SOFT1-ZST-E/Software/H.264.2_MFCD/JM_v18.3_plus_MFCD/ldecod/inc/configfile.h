...
Mapping Map[] = {
	...
	{"WriteUVForTexture",        &(cfgparams.write_uv[0]),                0,   0.0,                       1,  0.0,              1.0,                             },
    ...
    {"DeMuxMode",                &cfgparams.DeMuxMode,                    0,   0.0,                       1,  0.0,              1.0,                             },
    {"ExportViews",              &cfgparams.export_views,                 0,   0.0,                       1,  0.0,              1.0,                             },
    #if (MFC_DEC_3D_FCFR)
    {"EnableDbgYUVFiles",        &cfgparams.EnableDbgYUVFiles,            0,   0.0,                       1,  0.0,              1.0,                             },    //0-dont generate debug yuv files,1-generate yuv debug files
     #if (MFC_DEC_3D_FCFR_STAT)
    {"MBStat",                   &cfgparams.iMBStat,                      0,   1.0,                       1,  0.0,              2.0,                             },
