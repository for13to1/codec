...
typedef struct storable_picture
{
...
#if(MFC_DEC_3D_FCFR)
  imgpel **     postY;         //!< Y picture component
  imgpel ***    postUV;        //!< U and V picture components
#endif
  ...
  int         anchor_pic_flag;
#if (MFC_DEPTH_DEC)
  struct storable_picture   *dual_picture; 
  int*                      p_out;
  int                       is_depth;
...
extern void process_picture_in_dpb(VideoParameters *p_Vid, StorablePicture *p_pic);
