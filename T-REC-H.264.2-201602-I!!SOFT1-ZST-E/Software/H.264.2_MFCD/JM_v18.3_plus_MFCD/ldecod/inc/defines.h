...
#define MFC_DEC_3D_FCFR MVC_EXTENSION_ENABLE
#define MFC_DEPTH_DEC   MVC_EXTENSION_ENABLE

#define ENABLE_DEC_STATS          0    //!< enable decoder statistics collection

#define MVC_INIT_VIEW_ID          -1
#define MAX_VIEW_NUM              2    //1024   
...
#define MFC_DEC_3D_FCFR_STAT    0    //!< Print interlayer statistics
#define MFC_JM_CODE_CHANGE      1
#define MFC_PROFILING           0
#define JM186_bugfix            1    //!< bugfix from JM18.6
#endif
...
typedef enum {
  ...
  #if (MFC_DEC_3D_FCFR)
  ,
  MFC3D_HIGH   = 134      //!< YUV 4:2:0/8  "SBS+ High" 
