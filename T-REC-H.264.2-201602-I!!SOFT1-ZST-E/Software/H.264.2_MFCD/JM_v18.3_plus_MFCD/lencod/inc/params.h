...
struct inp_par_enc
{
  ...
  MFC_MUXING_PARAMS      mfc_muxing_params;    
  int                    EnableDbgYUVFiles;
  FILE *fp_mux_baselayer;
  FILE *fp_mux_enhlayer;
...
//////////////////////////////////////////////////////////////////////////
 ...
 int RDPictureDecisionEL;             //!< Perform RD optimal decision between various coded versions of same picture for EL
#endif 
