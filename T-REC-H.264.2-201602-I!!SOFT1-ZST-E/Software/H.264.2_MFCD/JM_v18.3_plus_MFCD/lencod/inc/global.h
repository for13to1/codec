...
typedef struct video_par
{
  ...
  struct storable_picture *proc_picture[MAX_NUM_DPB_LAYERS_MINUS_ONE];
#endif
#if (MFCD_INTERLACE)
int fld_cnt;
  ...
  struct stat_parameters  *p_Stats;
    ...
    struct stat_parameters  *p_layer_Stats[MAX_NUM_DPB_LAYERS];
#endif
...
//#endif
  ...
  void *pv_mfc_muxing_params;
  void *pv_mfc_encoder_layer_context; 

   #if(MFC_PROFILING)
   int64 mfc_rpu_time;   
   int64 mfc_BL_Muxing_time;   
   int64 mfc_EL_Muxing_time;   
...
#if (MFC_ENC_3D_FCFR)
static inline int is_MFC3D_profile(unsigned int profile_idc)
{
  return ( (profile_idc == MFC3D_HIGH));
}
#endif
