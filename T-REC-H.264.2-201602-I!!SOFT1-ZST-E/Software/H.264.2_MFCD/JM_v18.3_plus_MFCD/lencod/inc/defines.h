...
#define MFC_ENC_3D_FCFR          MVC_EXTENSION_ENABLE
#if(MFC_ENC_3D_FCFR)
#define MFC_PROCESS_INPUT               14 //!< Process Input format for MFC    
#define MFC_INTERLACE_POC_MANAGEMENT    1  //!< handle PocMemeoryManagement for interlace in MVC profile
#define MFC_JMCODE_FIX                  1  //!< fix JM code issue for interlaced coding
#define DISPLAY_LAYERLEVEL_BITUSAGE     1    
#define MFC_MV_RANGE                    0  //!< check motion vector range
#define MFC_ENC_EL_CONFIG               1  //!< enable encoder config for Enh. Layer: RDPictureDecision
#define MFC_PROFILING                   0  //!< enable profiling of MFC related code
#define MFC_FPA_SEI                     1  //!< enable FPA SEI message
#define MFC_MVC_HACK                    0  //!< enable syntax written as MVC in order to use analyzer to check bitstream conformance
#define MFC_FORCE_PAFF                  0  //!< enable PAFF manually, frame/fieds coding alternatively
#define JM186_bugfix                   1  //!< enable JM18.6 bugfix
#endif

#define MFC_DEPTH_ENC             MVC_EXTENSION_ENABLE
#if MFC_DEPTH_ENC
#define MAX_CODEVIEW              2     //!<the max number of coding view
#define MAX_CODEVIEWPLUSDEPTH     4     //!<the max number of coding view plus depth
#define MFC_DEPTH_COMMON          1
#define MFCD_FORCE_YUV_400        1     //!<Force YUV format 4:0:0
#define MFCD_REDUCED_RES          1     //!<Allow Depth to have reduced resolution
#define MFCD_INTERLACE            1     //!<Interlace support
#if MFCD_REDUCED_RES
...
#define MAX_NUM_DPB_LAYERS_MINUS_ONE         MAX_NUM_DPB_LAYERS-1
...
#define LD_REF_SETTING          0     ///!< used for low delay setting, 1+X referencing structure, as proposed in JCTVC-F701
...
#if(MFC_ENC_3D_FCFR)
  MFC3D_HIGH     = 134,      //!< YUV 4:2:0/8  "MFC3D High"
#endif
#if (MFC_DEPTH_ENC)
  ThreeDV_HIGH   = 138,       //! YUV 4:2:0/8  "Multiview Depth High"
  MFC_DEPTH_HIGH = 135,       //! YUV 4:2:0/8  "MFC Depth High"
#endif
